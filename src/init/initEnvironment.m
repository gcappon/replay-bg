...
%   - bolusSource: a vector of character defining whether to use, during 
%   replay, the insulin bolus data contained in the `data` timetable, or 
%   the boluses generated by the bolus calculator implemented via the 
%   provided `bolusCalculatorHandler`;
%   - basalSource: a vector of character defining whether to use, during
%   replay, the insulin basal data contained in the `data` timetable , or 
%   the basal generated by the controller implemented via the provided 
%   `basalControllerHandler`;
%   - choSource: a vector of character defining whether to use, during 
%   replay, the CHO data contained in the `data` timetable, or the CHO generated
%   by the meal generator implemented via the provided
