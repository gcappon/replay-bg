...
% ---------------------------------------------------------------------
    ...
    model = initModel(data,ip.Results.sampleTime, ip.Results.glucoseModel,ip.Results.pathology, ip.Results.coreModel, ip.Results.seed, environment);
    ...
    dss = initDecisionSupportSystem(BW,ip.Results.CR, ip.Results.CF, ip.Results.GT, ...
        ip.Results.mealGeneratorHandler, ip.Results.mealGeneratorHandlerParams, ...
